...
const EmailVerify = () => {
  ...
  const handleKeyDown = (e, index) => {
    ...
    const handlePaste = (e)=> {
      ...
      //It protects the /email-verify route from being shown to verified users.
      useEffect(() => {
        //If all are true → redirect them to / automatically.
  ...
  return (
    <div className='flex items-center justify-center min-h-screen  bg-gradient-to-br from-blue-200 to-purple-400'>
      <img onClick={()=>navigate('/')} src={assets.logo} alt="company's-Logo" 
